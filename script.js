document.addEventListener('DOMContentLoaded', () => {
    // Configuration will be loaded from environment variables set during build
    const config = {
        password: window.env?.PASSWORD || 'demo',
        apiKey: window.env?.SHORT_IO_API_KEY || '',
        shortDomain: window.env?.SHORT_DOMAIN || '',
    };
    ...
    if (!config.apiKey) {
        showError('API key not configured. Please set up environment variables properly.');
